    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link font-weight-bold">SISTEM INFORMASI</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a class="dropdown-item" data-toggle="modal" href="javascript:void(0)"
                            data-target="#lihatprofile">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            @if (auth()->user()->role == 'admin' ||
                    auth()->user()->role == 'PetugasAdministrasiSurat' ||
                    auth()->user()->role == 'PetugasAdministrasiKeuangan')
                ...
                @if (auth()->user()->role == 'admin')
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <a href="/pegawai/index" class="nav-link text-white">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview bg-secondary">
                                <li class="nav-item">
                                    <a href="/tabungan/setor/{{ $id_pesdik_login->id }}/siswaindex"
                                ...
                                <li class="nav-item">
                                    <a href="/tabungan/tarik/{{ $id_pesdik_login->id }}/siswaindex"
                                        class="nav-link text-white">
                                        <i class="fas fa-credit-card nav-icon"></i>
                                        <p>Tarik Tunai</p>
                        ...
                        <li class="nav-item">
                            <a href="/pembayaran/transaksipembayaran/{{ $id_pesdik_login->id }}/siswaindex"
                                class="nav-link">
