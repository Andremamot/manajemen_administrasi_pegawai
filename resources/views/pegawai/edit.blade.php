            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control bg-light" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">
                        <option value="Laki-Laki" @if ($guru->jenis_kelamin == 'Laki-Laki') selected @endif>-</option>
                        <option value="Perempuan" @if ($guru->jenis_kelamin == 'Perempuan') selected @endif>-</option>
                    </select>
                    <label for="tempat_lahir">Jabatan</label>
                    ...
                    <label for="tanggal_lahir">departemen</label>
